...
public interface IBilanRepository extends JpaRepository<Bilan, Long>{
    ...
    @Query("SELECT b.idBilan, b.annee, b.mois, b.quantiteDebut, b.quantiteFin, b.categorie.nom, b.categorie.idCategorie, b.approvisionnement,b.qteVenteOrdinaire, b.pUVO, b.qteVentePromotionnel, b.pUVP, b.destockage, b.defectueux FROM Bilan b WHERE b.annee = :x")
